...
module.exports = function( // eslint-disable-line complexity
    ...
    const useTypeScript = appPackage.dependencies['typescript'] !== null // eslint-disable-line dot-notation
    ...
    if (fs.existsSync(templateDependenciesPath)) {
        const templateDependencies = require(
            templateDependenciesPath).dependencies
    ...
    if (originalDirectory && path.join(originalDirectory, appName) ===
        appPath) {
        cdpath = appName
    } else {
        cdpath = appPath
