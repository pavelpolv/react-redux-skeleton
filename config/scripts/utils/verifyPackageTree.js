...
function verifyPackageTree() {
    ...
    const getSemverRegex = () =>
        /\bv?(?:0|[1-9]\d*)\.(?:0|[1-9]\d*)\.(?:0|[1-9]\d*)(?:-[\da-z-]+(?:\.[\da-z-]+)*)?(?:\+[\da-z-]+(?:\.[\da-z-]+)*)?\b/gi // eslint-disable-line max-len
    // const ownPackageJson = require('../../package.json');
    const ownPackageJson = require('../../../package')
        ...
        depsToCheck.forEach((dep) => {
            ...
            if (depPackageJson.version !== expectedVersion) {
                console.error(
                    ...
                    `  ${chalk.bold(
                        chalk.red(maybeDep))} (version: ${chalk.bold(
                    ...
                    `  ${chalk.cyan('1.')} Delete ${chalk.bold(
                        ...
                        'yarn.lock')} in your project folder.\n` +
